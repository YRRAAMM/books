...
public class ApiUtil {
    ...
    public final static String QUERY_PARAMETER_KEY = "q";
    public final static String KEY = "key";
    public final static String API_KEY = "AIzaSyAAhfjEl9d2TW1Int0I0NWW9UOQpN3WwDs";
...
// to make a url I guess to get the query
    ...
    public static URL buildUrl (String title, String author, String publisher, String ispn) {
        URL url = null;
        ...
        if (!ispn.isEmpty()) sb.append(ISBN).append(ispn).append("+");
